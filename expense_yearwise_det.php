...
<head>
    ...
    <title>Expensify - The Expense Manager || Yearwise Expense Report</title>
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    ...
    <?php
        $userid=$_SESSION['uid'];
        $ret=mysqli_query($conn,"SELECT year(ExpenseDate) as rptyear,SUM(ExpenseCost) as totalyear FROM expsenses where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by year(ExpenseDate)");
        $cnt=1;
